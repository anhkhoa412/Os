...
// SJF functionn 
   ...
   //Sorting of burst times
    ...
    printf("\nAverage Waiting Time using for Shortest Job First (Non-preemptive): %fms",avg_wt);
    printf("\nAverage Turnaround Time using for Shortest Job First (Non-preemptive):%fms",avg_tat);
    ...
    att = att * 1.0 / limit;
	printf("\n");
	printf("\nAverage Waiting Time Using Roun Robin:\t%fms", average_wait_time);
    printf("\nAvg Turnaround Time Using Roun Robin :\t%fms", average_turnaround_time);
    printf("\nAverage Waiting Time Using Roun Robin with overheads:\t%fms", awt);
    printf("\nAvg Turnaround Time Using Roun Robin with overheads  :\t%fms", att);
